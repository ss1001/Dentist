...
import com.network.volley_param;
 ...
 */
public class QandAFragment extends Fragment implements View.OnClickListener,back_info {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.next:
                ...
                volley_param request=new volley_param(getActivity(),"","get",param,this);
                request.setUrl(url);
                request.dopost();
        }
    }
